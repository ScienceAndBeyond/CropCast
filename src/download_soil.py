...
# Use get_stable_crop_mask(); a plain multi-year union includes too many
# one-off CDL edge pixels and misclassifications.
...
def run(states: List[str], resume: bool = True, force: bool = False) -> None:
    ...
    # Fresh runs clear the output file so append mode cannot duplicate rows.
