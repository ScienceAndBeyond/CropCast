"""Build paper tables and a short reproducibility summary."""
...
def write_outputs() -> None:
    ...
    lines = [
        "# Irrigation Paper Reproducibility Summary",
        "",
        "Generated by `python paper/paper_numbers.py` from local CSV artifacts.",
        "",
        ...
        "",
        "Tables written to `paper/tables/`, including county-bootstrap slope intervals.",
    ]
    (PAPER / "irrigation_reproducibility_summary.md").write_text("\n".join(lines) + "\n", encoding="utf-8")
